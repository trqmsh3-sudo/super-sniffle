        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/product-intel" className="text-slate-600 hover:text-mint-700 transition-colors">Product Intelligence</Link></li>
              <li><Link to="/search" className="text-slate-600 hover:text-mint-700 transition-colors">Search</Link></li>
